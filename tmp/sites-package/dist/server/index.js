globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-Zyoukjjl.js","assets/layout-segment-context-DfZwwMvJ.js"];
...
function getDraftSecret() {
	return "6cc84247-6f21-41e1-8e04-1d24d55c3fdc";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "25672d9d-66bc-46f1-9b4f-188403d71d66";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "25672d9d-66bc-46f1-9b4f-188403d71d66") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "25672d9d-66bc-46f1-9b4f-188403d71d66",
		rootBoundaryId
	});
}
/**
	...
	return {
		...
		openGraph: {
			...
			images: [{
				...
				width: 1536,
				height: 1024,
				alt: "Alsa Nudin - Full-Stack Developer and IT Professional"
			}]
		},
		twitter: {
